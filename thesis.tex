...
\begin{itemize}
\item Somebody did joint model for intents and slots
...
\begin{itemize}
\item Concatenate word embedding and contexts
\item Add fully connected layers and output layer
\end{itemize}
...
\label{se:training_and_hyperparameter_optimization}
\begin{itemize}
\item Optunity
\item Joint learning have proven to be challenging, lemma classification seem to hinder POS-tagging accuracy.
\item Results vary vastly on different hyperparameter combinations, finding suitable combination is crucial for good performance.
\end{itemize}
...
\label{ch:discussion}
\begin{itemize}
\item How well results generalize?
\item What was assumed?
\item What was simplified?
\end{itemize}
...
\begin{itemize}
\item Was hypothesis proved / disproved
