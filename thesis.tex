...
\begin{itemize}
\item Can be done with seq2seq which inserts linefeeds.
\item Can be done with character classification where each character is classified to be first character of a word.
...
\label{se:results}
\begin{itemize}
\item Syntaxnet and UDPipe
\item Separate POS-tagging and Lemmatization
...
\begin{itemize}
\item Need to be tested with more languages
\item Multiple languages in the same model
\end{itemize}
