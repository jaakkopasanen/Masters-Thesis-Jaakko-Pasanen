...
\item[Word vector] vector('Paris') - vector('France') + Vector('Italy') -> vector('Rome')
\end{termlist}
...
\subsection{Word2vec}
\begin{itemize}
\item Continuous Bag-of-Words is better for small datasets, Skip-gram is better for large datasets.
\end{itemize}
...
\item Connexor Machinese Syntax is the only currenty availavle Finnish full dependency parser.
