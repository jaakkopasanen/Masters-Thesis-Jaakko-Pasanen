...
\item Dual RNN architechture where 1st RNN encodes a sequence of tokens to fixed length vector and 2nd RNN decodeds that vector representation to a target sequence of tokens. \cite{Cho2014}, \cite{Bahdanau2014}
...
\begin{itemize}
\item Solution to deteriorating performance with long input sentences. \cite{Bahdanau2014}
