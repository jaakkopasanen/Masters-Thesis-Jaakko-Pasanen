...
\begin{itemize}
\item Natural Language Processing is vastly wide field, this thesis discusses only on the sections of natural language processing (NLP) relevant to the experiments.
...
\item See section 2.1 for Finnish Language quirks in \cite{Korenius2004}
...
\item Morphologically rich languages benefit from breaking the word into sub-parts, recurrent neural network (RNN) based character level model is not compared with Stem+ending. \cite{Takala2016}
